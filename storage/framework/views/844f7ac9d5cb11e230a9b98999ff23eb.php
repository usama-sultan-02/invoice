<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php if(Auth::check()): ?> <?php echo e(Auth::user()->name); ?><?php else: ?> Guest <?php endif; ?></a>
        </div>
      </div>
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH C:\xampp\htdocs\invoice\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>